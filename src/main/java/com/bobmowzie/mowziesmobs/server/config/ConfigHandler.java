...
public final class ConfigHandler {
    ...
    private static class General {
        private final ForgeConfigSpec.ConfigValue<String[]> freeze_blacklist;
        ...
        private General(final ForgeConfigSpec.Builder builder) {
            ...
            this.freeze_blacklist = builder.comment("Add a mob's full name here to prevent it from being frozen or taking damage from ice magic.")
                    .translation("config.mowziesmobs.freeze_blacklist")
                    .define("freeze_blacklist", new String[] {"mowziesmobs:frostmaw", "minecraft:ender_dragon"});
            builder.pop();
        }
    }
    ...
    public static String[] getFreezeBlacklist() {
        return GENERAL.freeze_blacklist.get();
    }
