...
public class EntityHandler {
    ...
    public static final RegistryObject<EntityType<EntitySculptor>> SCULPTOR = REG.register("sculptor", () -> EntityType.Builder.of(EntitySculptor::new, MobCategory.MISC).sized(1.0f, 2.3f).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "sculptor").toString()));
