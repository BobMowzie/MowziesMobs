...
public class EntityDart extends EntityTippedArrow {
    ...
    protected void onHit(RayTraceResult raytraceResultIn) {
        ...
        if (shootingEntity instanceof EntityBarakoa && living instanceof EntityBarakoa && ((EntityBarakoa) shootingEntity).isBarakoDevoted() == ((EntityBarakoa) living).isBarakoDevoted()) return;
