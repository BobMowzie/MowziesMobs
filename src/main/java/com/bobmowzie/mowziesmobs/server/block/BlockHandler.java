...
public final class BlockHandler {
    ...
    public static final RegistryObject<Block> GONG = registerBlockAndItem("gong", () -> new GongBlock(BlockBehaviour.Properties.copy(Blocks.GOLD_BLOCK).requiresCorrectToolForDrops().strength(3.0F).sound(SoundType.ANVIL)));
