...
public class StructureWroughtnautRoom {
	public static void generate(World world, BlockPos pos, Random rand, EnumFacing dir) {
		...
		if (dir == EnumFacing.NORTH)
			wroughtnaut.setPositionAndRotation(pos.getX() + 9.5, pos.getY() + 1, pos.getZ() + 0.5, 90, 0);
		else if (dir == EnumFacing.EAST)
			wroughtnaut.setPositionAndRotation(pos.getX() + 0.5, pos.getY() + 1, pos.getZ() + 9.5, 180, 0);
		else if (dir == EnumFacing.SOUTH)
			wroughtnaut.setPositionAndRotation(pos.getX() - 8.5, pos.getY() + 1, pos.getZ() + 0.5, 270, 0);
