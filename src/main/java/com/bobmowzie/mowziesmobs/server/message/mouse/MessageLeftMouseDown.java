...
public class MessageLeftMouseDown {
    ...
    public static void serialize(final MessageLeftMouseDown message, final FriendlyByteBuf buf) {

    }

    public static MessageLeftMouseDown deserialize(final FriendlyByteBuf buf) {
