    ...
    public void tick() {
        ...
        if (entity.getAnimation() == EntityWroughtnaut.ATTACK_ANIMATION) {
            ...
            if (entity.getAnimationTick() == 6) {
                ...
                float damage = (float)entity.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getValue() * ConfigHandler.COMMON.MOBS.FERROUS_WROUGHTNAUT.combatConfig.attackMultiplier.get().floatValue();
                boolean hit = false;
