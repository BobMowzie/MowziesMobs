...
public class ModelFoliaathBaby<T extends EntityBabyFoliaath> extends MowzieEntityModel<T> {
    ...
    public ModelFoliaathBaby() {
        ...
        juvenileLeaf3.setPos(-1.0F, 0.0F, 1.0F);
        ...
        juvenileLeaf2.setPos(-1.0F, 0.0F, -1.0F);
        ...
        juvenileLeaf1.setPos(1.0F, 0.0F, -1.0F);
        ...
        infantLeaf1.setPos(0.2F, 0.0F, -0.2F);
        ...
        infantLeaf4.setPos(0.0F, 0.0F, 0.0F);
        ...
        mouthCover.setPos(0.0F, -1.0F, 0.0F);
    ...
    public void setDefaultAngles(EntityBabyFoliaath entity, float limbSwing, float limbSwingAmount, float headYaw, float headPitch, float delta) {
        ...
        mouth1.zRot += 0.5 * openMouthProgress;
        mouth2.zRot -= 0.5 * openMouthProgress;
        ...
        infantBase.visible = !(juvenileBase.visible = !entity.getInfant());
    }
