...
public class ModelGrottol<T extends EntityGrottol> extends MowzieEntityModel<T> {
    ...
    public ModelGrottol() {
        ...
        this.crystal7.setPos(-3.6F, -2.4F, 1.7F);
        ...
        this.clawRightJoint.setPos(-2.0F, 2.0F, -3.5F);
        ...
        this.leg1RightUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.leg1LeftUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.leg3LeftJoint.setPos(3.5F, 2.0F, 1.5F);
        ...
        this.clawLeft.setPos(3.5F, 0.0F, 0.0F);
        ...
        this.leg3RightLower.setPos(-3.3F, -0.5F, 0.0F);
        ...
        this.leg3RightJoint.setPos(-3.5F, 2.0F, 1.5F);
        ...
        this.clawRightUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.foot3Left.setPos(3.2F, 0.0F, 0.0F);
        ...
        this.crystal5.setPos(4.0F, -3.0F, -3.5F);
        ...
        this.clawLeftJoint.setPos(2.0F, 2.0F, -3.5F);
        ...
        this.clawLeftLower.setPos(3.0F, -0.5F, 0.0F);
        ...
        this.crystal4.setPos(-4.5F, -3.0F, -2.0F);
        ...
        this.foot2Left.setPos(3.3F, 0.0F, 0.0F);
        ...
        this.clawRightLower.setPos(-3.0F, -0.5F, 0.0F);
        ...
        this.clawLeftUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.leg1LeftJoint.setPos(3.2F, 2.0F, -1.8F);
        ...
        this.crystal1.setPos(2.0F, -4.0F, -1.0F);
        ...
        this.clawRight.setPos(-3.5F, 0.0F, 0.0F);
        ...
        this.leg2LeftUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.leg1LeftLower.setPos(3.0F, -0.5F, 0.0F);
        ...
        this.leg2RightUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.crystal3.setPos(0.0F, -3.0F, -4.8F);
        ...
        this.eyeLeft.setPos(2.0F, -0.5F, -2.5F);
        ...
        this.head.setPos(0.0F, 1.5F, -5.0F);
        ...
        this.foot1Right.setPos(-3.0F, 0.0F, 0.0F);
        ...
        this.leg2RightLower.setPos(-3.3F, -0.5F, 0.0F);
        ...
        this.foot3Right.setPos(-3.2F, 0.0F, 0.0F);
        ...
        this.crystal6.setPos(2.0F, -3.0F, 3.0F);
        ...
        this.foot2Right.setPos(-3.3F, 0.0F, 0.0F);
        ...
        this.crystal2.setPos(-2.0F, -3.0F, 1.0F);
        ...
        this.foot1Left.setPos(3.0F, 0.0F, 0.0F);
        ...
        this.leg2LeftLower.setPos(3.3F, -0.5F, 0.0F);
        ...
        this.leg1RightLower.setPos(-3.0F, -0.5F, 0.0F);
        ...
        this.leg2RightJoint.setPos(-3.8F, 2.0F, -0.1F);
        ...
        this.leg3RightUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.eyeRight.setPos(-2.0F, -0.5F, -2.5F);
        ...
        this.leg3LeftUpper.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.leg1RightJoint.setPos(-3.2F, 2.0F, -2.0F);
        ...
        this.leg3LeftLower.setPos(3.3F, -0.5F, 0.0F);
        ...
        this.leg2LeftJoint.setPos(3.8F, 2.0F, -0.1F);
        ...
        this.dieAnimController.setPos(0, 0, 0);
...
//        setRotationAngles(entity, limbSwing, limbSwingAmount, headYaw, headPitch, delta);
        ...
        if (entity.getAnimation() == EntityGrottol.DIE_ANIMATION) {
            ...
            body.y -= 18 * (-4 * dieAnimController.x * dieAnimController.x + 4 * dieAnimController.x);
            float globalSpeed = 1f;
            float globalDegree = 0.5f * dieAnimController.y;
            flap(body, globalSpeed, globalDegree * 0.2f, true, 0, 0, frame, 1);
            body.x -= 1 * globalDegree * Math.cos(frame * globalSpeed);
