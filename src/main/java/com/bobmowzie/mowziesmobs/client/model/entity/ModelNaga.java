...
public class ModelNaga<T extends EntityNaga> extends MowzieEntityModel<T> {
    ...
    public ModelNaga() {
        ...
        this.eyebrow_L.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.spike3joint.setPos(0.0F, 1.0F, 4.0F);
        ...
        this.headJoint.setPos(0.0F, 1.0F, -13.0F);
        ...
        this.body.setPos(0.0F, -9.0F, -9.0F);
        ...
        this.lowerArmJoint_R.setPos(-15.0F, 0.0F, -0.5F);
        ...
        this.wingWebbing5_L.setPos(12.0F, 0.0F, 1.0F);
        ...
        this.wingWebbing5_LReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing5_LReversed.setScale(1, -1, 1);
        ...
        this.wingWebbing2_LReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing2_LReversed.setScale(1, -1, 1);
        ...
        this.lowerArm_R.setPos(0.0F, 0.0F, -0.5F);
        ...
        this.eyebrowJoint_L.setPos(4.95F, -5.0F, -7.36F);
        ...
        this.eyebrow_R.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.wingWebbing3_R.setPos(-1.0F, 0.0F, 0.0F);
        ...
        this.wingWebbing3_RReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing3_RReversed.setScale(1, -1, 1);
        ...
        this.wingWebbing3_L.setPos(1.0F, 0.0F, 0.0F);
        ...
        this.wingWebbing3_LReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing3_LReversed.setScale(1, -1, 1);
        ...
        this.shoulder1_L.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.spike5joint.setPos(0.0F, 0.0F, -4.05F);
        ...
        this.wingWebbing1_R.setPos(2.0F, 0.0F, 0.0F);
        ...
        this.wingWebbing1_RReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing1_RReversed.setScale(1, -1, 1);
        ...
        this.upperArmJoint_L.setPos(9.0F, -1.0F, -1.0F);
        ...
        this.tail1.setPos(0.0F, 1.5F, 17.0F);
        ...
        this.wingWebbing5_R.setPos(-12.0F, 0.0F, 1.0F);
        ...
        this.wingWebbing5_RReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing5_RReversed.setScale(1, -1, 1);
        ...
        this.backFin3.setPos(0.0F, -3.0F, 0.0F);
        ...
        this.backFin3Reversed.setPos(0.001F, 0.0F, 0.0F);
...
//        backFin3Reversed.setScale(-1, 1, 1);
        ...
        this.wingWebbing4_LReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing4_LReversed.setScale(1, -1, 1);
        ...
        this.wingFrame3_L.setPos(4.0F, 0.0F, 0.0F);
        ...
        this.wingWebbing1_L.setPos(-2.0F, 0.0F, 0.0F);
        ...
        this.wingWebbing1_LReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing1_LReversed.setScale(1, -1, 1);
        ...
        this.wingClaw_R.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.eyebrowJoint_R.setPos(-4.95F, -5.0F, -7.36F);
        ...
        this.wingFrame2_R.setPos(-7.0F, 0.0F, 0.0F);
        ...
        this.wingWebbing2_R.setPos(1.5F, 0.0F, 0.0F);
        ...
        this.wingWebbing2_RReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing2_RReversed.setScale(1, -1, 1);
        ...
        this.jaw.setPos(0.0F, -1.34F, -4.38F);
        ...
        this.spike3Bottom.setPos(0.0F, 2.69F, 5.66F);
        ...
        this.teethLower.setPos(0.0F, 0.14F, -9.4F);
        ...
        this.lowerArm_L.setPos(0.0F, 0.0F, -0.5F);
        ...
        this.backWing_R.setPos(-4.0F, 0.0F, 4.0F);
        ...
        this.backWing_RReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        backWing_RReversed.setScale(1, -1, 1);
        ...
        this.tailFinReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        tailFinReversed.setScale(1, -1, 1);
        ...
        this.underHead.setPos(0.0F, -1.82F, -1.59F);
        ...
        this.backFin2.setPos(0.0F, -4.5F, 0.0F);
        ...
        this.backFin2Reversed.setPos(0.0F, 0.0F, 0.0F);
...
//        backFin2Reversed.setScale(-1, 1, 1);
        ...
        this.upperArmJoint_R.setPos(-9.0F, -1.0F, -1.0F);
        ...
        this.spike1joint.setPos(0.0F, 1.0F, -12.0F);
...
//        backFin1Reversed.setScale(-1, 1, 1);
        ...
        this.wingWebbing4_R.setPos(-0.5F, 0.0F, 0.0F);
        ...
        this.wingWebbing4_RReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing4_RReversed.setScale(1, -1, 1);
        ...
        this.backWing_LReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        backWing_LReversed.setScale(1, -1, 1);
        ...
        this.wingWebbing6_R.setPos(-0.5F, 0.0F, -2.0F);
        ...
        this.wingWebbing6_RReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing6_RReversed.setScale(1, -1, 1);
        ...
        this.spike2joint.setPos(0.0F, 1.0F, -4.0F);
        ...
        this.wingWebbing6_L.setPos(0.5F, 0.0F, -2.0F);
        ...
        this.wingWebbing6_LReversed.setPos(0.0F, -0.004F, 0.0F);
...
//        wingWebbing6_LReversed.setScale(1, -1, 1);
        ...
        this.wingFrame4_R.setPos(-2.0F, 0.0F, 0.0F);
        ...
        this.tail4.setPos(0.0F, -0.5F, 15.0F);
        ...
        this.wingFrame3_R.setPos(-4.0F, 0.0F, 0.0F);
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        ...
        for (AdvancedModelRenderer AdvancedModelRenderer : tailOriginal) {
            AdvancedModelRenderer.visible = false;
        }
    }
    ...
    public void setDefaultAngle(EntityNaga entity, float limbSwing, float limbSwingAmount, float headYaw, float headPitch, float delta) {
        ...
        if (!frozen) {
            ...
            wingFolder.x = globalDegree * flapAnim * (0.9f * (float) (0.5 * Math.cos(frame * globalSpeed + 1.4 + flapTimingOffset) + 0.5) + 0.05f);
            wingFolder.y = globalDegree * flapAnim * (0.9f * (float) (0.5 * Math.cos(frame * globalSpeed + 1.4 + flapTimingOffset) + 0.5) + 0.05f);
            ...
            root.y += 18 * globalDegree * flapAnim;

            body.xRot -= 0.2f * globalDegree;
            neck.xRot += 0.2f * globalDegree;
            headJoint.xRot += 0.2f * globalDegree;
            ...
            if (entity.movement == EntityNaga.EnumNagaMovement.FALLING && entity.getAnimation() == EntityNaga.NO_ANIMATION) {
                ...
                shoulder1_R.zRot += -1f;
                shoulder1_L.zRot += 1f;
                lowerArm_L.zRot += 0.3f;
                lowerArm_R.zRot += -0.3f;
                handJoint_L.zRot += 0.2f;
                handJoint_R.zRot += -0.2f;
                neck.xRot += 0.3f;
                headJoint.xRot += 0.3f;
                ...
                wingFolder.x += 0.6f;
                wingFolder.y += 0.7f;
                shoulder1_R.zRot += -1.5f;
                shoulder1_L.zRot += 1f;
                upperArm_L.xRot += 0.2f;
                upperArm_L.zRot += 0.4;
                lowerArmJoint_L.xRot += 0.4f;
                lowerArmJoint_L.yRot += -0.5f;
                neck.xRot += 0.4f;
                headJoint.xRot += 0.4f;
                tail1.xRot += -0.35f;
                tail2.xRot += -0.35f;
...
//        jaw.rotateAngleX += 1.6f * (smoothBlend(roarFrac, 0.2f, 30) - smoothBlend(roarFrac, 0.8f, 30));
    ...
    protected void animate(EntityNaga entity, float limbSwing, float limbSwingAmount, float headYaw, float headPitch, float delta) {
        ...
        if (!frozen) {
            ...
            if (entity.getAnimation() == EntityNaga.SPIT_ANIMATION) {
                ...
                body.setScale(1 + scaler.x, 1 + scaler.x * 2, 1 + scaler.x);
                body.scaleChildren = false;
                float scaleSpeed = 1f;
                float neckScaler = 0.6f * (float) Math.max(Math.pow(Math.sin((scaler.y * scaleSpeed + (1 - scaleSpeed) / 2) * Math.PI + 0.4), 3), 0);
                neck.setScale(1 + neckScaler, 1 + neckScaler * 1.5f, 1 + neckScaler);
                neck.y += neckScaler * 6;
                headJoint.y -= neckScaler * 6;
                neck.scaleChildren = false;
                float headScaler = 0.5f * (float) Math.max(Math.pow(Math.sin((scaler.y * scaleSpeed + (1 - scaleSpeed) / 2) * Math.PI - 0.4), 3), 0);
                headJoint.setScale(1 + headScaler, 1 + headScaler, 1 + headScaler);
                headJoint.y += headScaler * 6;
                headJoint.z -= headScaler * 6;
            ...
            if (entity.getAnimation() == EntityNaga.SWOOP_ANIMATION) {
                ...
                root.x += 30 * (float) Math.sin(swooper.x * Math.PI * 2);
                root.z -= 10 * (float) (swooper.x * (-Math.cos(swooper.x * 2 * Math.PI) + 1) - Math.pow(swooper.x, 2));
                root.yRot += 2 * Math.PI * swooper.x * swooper.x;
                root.y += 10 * (float) (swooper.x * (-Math.cos(swooper.x * 2 * Math.PI) + 1) - Math.pow(swooper.x, 2));
                wingFolder.x += 0.9 * smoothBlend(swooper.x, 0.1f, 20) - 0.4 * smoothBlend(swooper.x, 0.95f, 50);
                wingFolder.y += 0.9 * smoothBlend(swooper.x, 0.1f, 20) - 0.8 * smoothBlend(swooper.x, 0.95f, 50);
                shoulder1_R.zRot += 1.0 * smoothBlend(swooper.x, 0.1f, 20) - 0.6 * smoothBlend(swooper.x, 0.95f, 50);
                shoulder1_L.zRot -= 1.0 * smoothBlend(swooper.x, 0.1f, 20) - 0.2 * smoothBlend(swooper.x, 0.95f, 50);
                shoulder1_L.yRot += 0.2 * smoothBlend(swooper.x, 0.95f, 50);
                body.xRot += 1.0 * smoothBlend(swooper.x, 0.15f, 20) - 1.5 * smoothBlend(swooper.x, 0.7f, 20);
                body.zRot -= 0.6 * smoothBlend(swooper.x, 0.15f, 20) - 0.6 * smoothBlend(swooper.x, 0.7f, 20);
                neck.xRot += -0.8 * smoothBlend(swooper.x, 0.25f, 20) + 1.1 * smoothBlend(swooper.x, 0.7f, 20);
                headJoint.xRot += -0.8 * smoothBlend(swooper.x, 0.25f, 20) + 1.1 * smoothBlend(swooper.x, 0.7f, 20);
                body.x += 10 * smoothBlend(swooper.x, 0.95f, 50);
                body.yRot += 0.2 * smoothBlend(swooper.x, 0.95f, 50);
                headJoint.yRot += 0.1 * smoothBlend(swooper.x, 0.95f, 50);
                neck.yRot += 0.1 * smoothBlend(swooper.x, 0.95f, 50);
                tail1.yRot -= 0.3 * smoothBlend(swooper.x, 0.95f, 50);
                tail2.yRot -= 0.3 * smoothBlend(swooper.x, 0.95f, 50);
                tail3.yRot -= 0.3 * smoothBlend(swooper.x, 0.95f, 50);
                tail4.yRot -= 0.3 * smoothBlend(swooper.x, 0.95f, 50);

                body.zRot += 1f * frame % (Math.PI * 2) * swooper.y;
            ...
            float flapFrame = (float) ((wingFolder.xRot * Math.PI * 2f / globalSpeed) - (Math.PI * 0.5 / globalSpeed));
            globalDegree *= 1 - Math.pow(Math.sin(wingFolder.xRot * Math.PI - Math.PI / 2), 8);

            double folder = 0.5 * Math.cos(flapFrame * globalSpeed + 1.4) + 0.5;
            wingFolder.x += globalDegree * (0.9f * (float) folder + 0.05f);
            wingFolder.y += globalDegree * (0.9f * (float) folder + 0.05f);
            ...
            if (entity.getAnimation() != EntityNaga.DIE_AIR_ANIMATION) {
                float pitch = entity.xRotO + (entity.xRot - entity.xRotO) * delta;
                pitch = (float) (-pitch * Math.PI / 180f);
                root.xRot += pitch * nonHoverAnim;
                shoulderLJoint.xRot -= Math.min(pitch, 0) * nonHoverAnim * (1-folder);
                shoulderRJoint.xRot -= Math.min(pitch, 0) * nonHoverAnim * (1-folder);

                double folder2 = Math.max(Math.min(pitch, 0.8), 0.1) * nonHoverAnim * (1 - flapAnim);
                wingFolder.x += folder2 * folder;
                wingFolder.y += folder2 * folder;

                float banking = entity.prevBanking + (entity.banking - entity.prevBanking) * delta;
                body.zRot -= 10 * Math.toRadians(banking) * nonHoverAnim;
            }
            ...
            entity.shoulderRot = shoulder1_R.zRot;
        }
    }

    private void jawControls() {
        teethUpper.setScale(1, 1, 0.5f + 0.5f * Math.min(jaw.xRot, 1));
        underHead.setScale(1, 1, 1f - 0.2f * Math.min(jaw.xRot, 1));
        underHead.z += 1.2 * Math.min(jaw.xRot, 1);
    }

    private void wingFoldControls() {
        shoulder1_R.yRot += 0.8 * wingFolder.x;
        upperArm_R.yRot += 0.3 * wingFolder.x;
        lowerArm_R.yRot -= 2.7 * wingFolder.x;
        hand_R.yRot += 1.8 * wingFolder.x;
        wingFrame1_R.yRot += 0.8 * wingFolder.x;
        wingFrame2_R.yRot += 0.3 * wingFolder.x;
        wingFrame3_R.yRot -= 0.2 * wingFolder.x;
        wingFrame4_R.yRot -= 0.7 * wingFolder.x;

        shoulder1_L.yRot -= 0.8 * wingFolder.y;
        upperArm_L.yRot -= 0.3 * wingFolder.y;
        lowerArm_L.yRot += 2.7 * wingFolder.y;
        hand_L.yRot -= 1.8 * wingFolder.y;
        wingFrame1_L.yRot -= 0.8 * wingFolder.y;
        wingFrame2_L.yRot -= 0.3 * wingFolder.y;
        wingFrame3_L.yRot += 0.2 * wingFolder.y;
        wingFrame4_L.yRot += 0.7 * wingFolder.y;
    }
    ...
    private void modelCorrections() {
        ...
        backFin1.x += 0.001;
        backFin1Reversed.x -= 0.002;
        backFin2.x += 0.0005;
        backFin2Reversed.x -= 0.001;
        handJoint_L.y += 0.01;
        handJoint_R.y += 0.01;
        ...
        backWing_LReversed.x = 30;
        backWing_RReversed.x = -30;
        tailFinReversed.x = 20;
        wingWebbing1_LReversed.x = 53;
        wingWebbing1_RReversed.x = -53;
        wingWebbing2_LReversed.x = 50;
        wingWebbing2_RReversed.x = -50;
        wingWebbing3_LReversed.x = 43;
        wingWebbing3_RReversed.x = -43;
        wingWebbing4_LReversed.x = 31;
        wingWebbing4_RReversed.x = -31;
        wingWebbing5_LReversed.x = -4;
        wingWebbing5_RReversed.x = 4;
        wingWebbing6_LReversed.x = 4;
        wingWebbing6_RReversed.x = -4;
        backFin1Reversed.yRot = (float) Math.PI;
        backFin1Reversed.z = 20;
    }
    ...
    private void computeWingWebbing() {
        ...
        float webbing1LScale = (float) ((wingFrame1_L.yRot - wingFrame2_L.yRot)/(Math.toRadians(35)));
        webbing1LScale = 0.8f * webbing1LScale + 0.2f;
        float webbing1LRot = (float) (-(wingFrame1_L.yRot - (wingFrame2_L.yRot + Math.toRadians(35)))/2);
        wingWebbing1_L.yRot += webbing1LRot;
        wingWebbing1_L.setScale(1 - webbing1LScale * 0.07f, 1, webbing1LScale);
        float webbing2LScale = (float) ((wingFrame2_L.yRot - wingFrame3_L.yRot)/(Math.toRadians(35)));
        webbing2LScale = 0.8f * webbing2LScale + 0.2f;
        float webbing2LRot = (float) (-(wingFrame2_L.yRot - (wingFrame3_L.yRot + Math.toRadians(35)))/2);
        wingWebbing2_L.yRot += webbing2LRot;
        wingWebbing2_L.setScale(1 - webbing2LScale * 0.07f, 1, webbing2LScale);
        float webbing3LScale = (float) ((wingFrame3_L.yRot - wingFrame4_L.yRot)/(Math.toRadians(35)));
        webbing3LScale = 0.8f * webbing3LScale + 0.2f;
        float webbing3LRot = (float) (-(wingFrame3_L.yRot - (wingFrame4_L.yRot + Math.toRadians(35)))/2);
        wingWebbing3_L.yRot += webbing3LRot;
        wingWebbing3_L.setScale(1 - webbing3LScale * 0.07f, 1, webbing3LScale);
        float webbing4LScale = 1 - (float) (-0.5 * hand_L.yRot);
        float webbing4LRot = (float) (-(wingFrame4_L.yRot + hand_L.yRot + Math.toRadians(105))/2);
        wingWebbing4_L.yRot += webbing4LRot;
        wingWebbing4_L.setScale(1 - webbing4LScale * 0.02f, 1, webbing4LScale);
        wingWebbing5_L.x += 12 * (float) (upperArm_L.yRot/Math.toRadians(35));
        wingWebbing5_L.setScale((float) (2 - (-shoulder1_L.yRot + shoulder1_L.defaultRotationY)/1.5), 1, (float) (0.915 - (-shoulder1_L.yRot + shoulder1_L.defaultRotationY)/1.2));
        wingWebbing6_L.setScale(1 + (-shoulder1_L.yRot + shoulder1_L.defaultRotationY)/4, 1, (float) (1 - (-shoulder1_L.yRot + shoulder1_L.defaultRotationY)/1.6));
        wingWebbing6_L.x += 14 * (-shoulder1_L.yRot + shoulder1_L.defaultRotationY);

        float webbing1RScale = (float) (-(wingFrame1_R.yRot - wingFrame2_R.yRot)/(Math.toRadians(35)));
        webbing1RScale = 0.8f * webbing1RScale + 0.2f;
        float webbing1RRot = (float) (-(wingFrame1_R.yRot - (wingFrame2_R.yRot - Math.toRadians(35)))/2);
        wingWebbing1_R.yRot += webbing1RRot;
        wingWebbing1_R.setScale(1 - webbing1RScale * 0.07f, 1, webbing1RScale);
        float webbing2RScale = (float) (-(wingFrame2_R.yRot - wingFrame3_R.yRot)/(Math.toRadians(35)));
        webbing2RScale = 0.8f * webbing2RScale + 0.2f;
        float webbing2RRot = (float) (-(wingFrame2_R.yRot - (wingFrame3_R.yRot - Math.toRadians(35)))/2);
        wingWebbing2_R.yRot += webbing2RRot;
        wingWebbing2_R.setScale(1 - webbing2RScale * 0.07f, 1, webbing2RScale);
        float webbing3RScale = (float) (-(wingFrame3_R.yRot - wingFrame4_R.yRot)/(Math.toRadians(35)));
        webbing3RScale = 0.8f * webbing3RScale + 0.2f;
        float webbing3RRot = (float) (-(wingFrame3_R.yRot - (wingFrame4_R.yRot - Math.toRadians(35)))/2);
        wingWebbing3_R.yRot += webbing3RRot;
        wingWebbing3_R.setScale(1 - webbing3RScale * 0.07f, 1, webbing3RScale);
        float webbing4RScale = 1 - (float) (0.5 * hand_R.yRot);
        float webbing4RRot = (float) (-(wingFrame4_R.yRot + hand_R.yRot - Math.toRadians(105))/2);
        wingWebbing4_R.yRot += webbing4RRot;
        wingWebbing4_R.setScale(1 - webbing4RScale * 0.02f, 1, webbing4RScale);
        wingWebbing5_R.x -= 12 * (float) (-upperArm_R.yRot/Math.toRadians(35));
        wingWebbing5_R.setScale((float) (2 - (shoulder1_R.yRot - shoulder1_R.defaultRotationY)/1.5), 1, (float) (0.915 - (shoulder1_R.yRot - shoulder1_R.defaultRotationY)/1.2));
        wingWebbing6_R.setScale(1 + (shoulder1_R.yRot - shoulder1_R.defaultRotationY)/4, 1, (float) (1 - (shoulder1_R.yRot - shoulder1_R.defaultRotationY)/1.6));
        wingWebbing6_R.x += 14 * (shoulder1_L.yRot - shoulder1_L.defaultRotationY);
...
//        wingWebbing4_R.rotateAngleZ -= 0.5/2 * (-lowerArmJoint_R.rotateAngleZ - handJoint_R.rotateAngleZ * 2);
        ...
        wingWebbing4_R.y -= 0.01f;
        wingWebbing4_L.y -= 0.01f;
        wingWebbing5_R.y += 0.01f;
        wingWebbing5_L.y += 0.01f;
        wingWebbing3_R.y += 0.01f;
        wingWebbing3_L.y += 0.01f;

        tailFin.y -= 0.1f;

        if (tailDynamic[0] != null) {
            backFin1.setScale(1, 1, 1 - 0.5f * tailDynamic[0].xRot);
            backFin1.scaleChildren = true;
            backFin1.x += 0.002;
            backFin1Reversed.x -= 0.004;

            backFin2.setScale(1, 1, 1 - 0.2f * tailDynamic[1].xRot);
            backFin2.scaleChildren = true;
            backFin2.x += 0.001;
            backFin2Reversed.x -= 0.002;
        }
    }
