...
public class ModelSculptor extends MowzieGeoModel<EntitySculptor> {
    ...
    @Override
    public void codeAnimations(EntitySculptor entity, Integer uniqueID, AnimationState<?> animationState) {
    ...
    private void beadsCorrections(EntitySculptor entity) {
        ...
        GeoBone headJoint = this.getBone("head_joint").get();
    ...
    private void skirtCorrections(EntitySculptor entity) {
        ...
        Matrix4f mat = new Matrix4f(frontCloth.getModelRotationMat());
        mat.invert();
