...
public class CustomBossBar {
    ...
    static {
        customBossBars.put(EntityHandler.UMVUTHI.get().getRegistryName(), new CustomBossBar(
        ...
        customBossBars.put(EntityHandler.FROSTMAW.get().getRegistryName(), new CustomBossBar(
