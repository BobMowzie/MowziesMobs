...
public class ParticleVanillaCloudExtended extends SpriteTexturedParticle {
    ...
    protected ParticleVanillaCloudExtended(ClientLevel worldIn, IAnimatedSprite animatedSprite, double xCoordIn, double yCoordIn, double zCoordIn, double motionX, double motionY, double motionZ, double scale, double r, double g, double b, double drag, double duration, Vec3[] destination) {
    ...
    public void tick()
    {
        ...
        if (destination != null && destination.length == 1) {
            ...
            Vec3 diff = destinationVec.subtract(new Vec3(posX, posY, posZ));
    ...
    public static final class CloudFactory implements IParticleFactory<VanillaCloudData> {
        ...
        @Override
        public Particle makeParticle(VanillaCloudData typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class VanillaCloudData implements IParticleData {
        public static final IParticleData.IDeserializer<VanillaCloudData> DESERIALIZER = new IParticleData.IDeserializer<VanillaCloudData>() {
            ...
            public VanillaCloudData read(ParticleType<VanillaCloudData> particleTypeIn, FriendlyByteBuf buffer) {
