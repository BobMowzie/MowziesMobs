...
public final class VanillaParticleFactory<T extends Particle> extends ParticleFactory<VanillaParticleFactory<T>, T> {
    ...
    /**
     * Creates a vanilla particle factory that builds particles from an
     * {@link IParticleFactory}.
     * <p>
     * <b>Do note that the first value in the additional arguments must be the
     * particle ID (default is 0)!</b>
     * 
     * @param type
     * @param factory
     */
    ...
    protected T createParticle(ImmutableParticleArgs args) {
        ...
        if (data.length > 1) {
            ...
            return (T) this.factory.makeParticle((int) data[0], args.world, args.x, args.y, args.z, args.motionX, args.motionY, args.motionZ, additionalArgs);
        } else {
            return (T) this.factory.makeParticle((int) data[0], args.world, args.x, args.y, args.z, args.motionX, args.motionY, args.motionZ);
        }*/
        return null;
    }
