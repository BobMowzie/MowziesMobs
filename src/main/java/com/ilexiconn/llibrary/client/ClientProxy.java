...
import com.bobmowzie.mowziesmobs.server.net.MessageContext;
...
public class ClientProxy extends ServerProxy {
    ...
    public static final SurvivalTab INVENTORY_TAB = SurvivalTabHandler.INSTANCE.create("container.inventory", Gui.class);
    ...
    public <T extends AbstractMessage<T>> void handleMessage(final T message, final NetworkEvent.Context messageContext) {
        if (messageContext.getDirection() == NetworkDirection.PLAY_TO_SERVER) {
